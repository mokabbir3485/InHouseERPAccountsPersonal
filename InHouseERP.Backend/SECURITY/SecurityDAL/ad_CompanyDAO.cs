...
namespace SecurityDAL
{
    public class ad_CompanyDAO //: IDisposible
    {
        ...
        public List<ad_Company> GetAll(int? companyId = null)
        {
            try
            {
                var ad_CompanyLst = new List<ad_Company>();
                ...
                ad_CompanyLst =
                    dbExecutor.FetchData<ad_Company>(CommandType.StoredProcedure, "pos_SalesInvoice_GetCompanyForPayment", colparameters);
                return ad_CompanyLst;
            }
            catch (Exception ex)
            {
