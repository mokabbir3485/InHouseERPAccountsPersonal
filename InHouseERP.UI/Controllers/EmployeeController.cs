...
namespace Security.UI.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public JsonResult GetEmployeeByRefEmployeeId()
        {
            try
            {
                var list = Facade.Employee.GetEmployeeByRefEmployeeId();
                return Json(list, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetEmployeeEmailByDocumentRef(int refEmployeeId, int? PaymentProcessTypeId = null)
        {
            try
            {
